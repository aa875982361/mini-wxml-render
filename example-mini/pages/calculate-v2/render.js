...
function run(_ref) {
  ...
  var templateVDomCreateList = [{
    ...
    "_a": [{
      "uid": 2,
      "_b": "pages/calculate/calculate.wxml"
    }],
    "_c": "text"
  }, {
    "uid": 4,
      ...
      "_a": [{
        ...
        "_b": function _b(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1Adata.num\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message); // console.warn("错误：", e)
          }
      ...
      "_a": [{
        ...
        "_a": [{
          ...
          "_b": function _b(data) {
            ...
            try {
              res = "操作数1+操作数2的结果为: " + (data.op1 + data.op2) + "";
            } catch (e) {
              console.warn("\u6267\u884C\uFF1A\"\u64CD\u4F5C\u65701+\u64CD\u4F5C\u65702\u7684\u7ED3\u679C\u4E3A: \"+(data.op1 + data.op2)+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message); // console.warn("错误：", e)
            }
  ...
  function eventHandler(event) {
    ...
    if (id && type) {
      ...
      var value = uidEventHandlerFuncMap[key];
  ...
  function Page(pageObj) {
    ...
    pageObj._render = function (callback) {
      ...
      if (isFirstRender) {
        ...
        page.setData(_defineProperty({}, vdomsKey, vdoms), firstRenderCallback(callback));
      } else {
        // 如果是再次渲染
