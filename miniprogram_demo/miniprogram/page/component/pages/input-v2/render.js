...
function run(_ref) {
  ...
  var uidEventHandlerFuncMap = {
    ...
    "994_input": {
      "value": "bindReplaceInput",
      "isCatch": false
    },
    "1008_input": {
      "value": "bindHideKeyboard",
      "isCatch": false
    }
  };
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'input'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
        ...
        "children": [{
          ...
          "children": [{
            "content": function content(data) {
              ...
              try {
                res = "实时获取输入值：" + data.inputValue + "";
              } catch (e) {
                console.warn("\u6267\u884C\uFF1A\"\u5B9E\u65F6\u83B7\u53D6\u8F93\u5165\u503C\uFF1A\"+(data.inputValue)+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
  ...
  var dataKeys = ["list", "item", "theme", "platform", "position", "showCanvas", "frameHeight", "frameWidth", "width", "height", "src", "videoSrc", "result", "canIUse", "items", "latitude", "longitude", "editorHeight", "placeholder", "isIOS", "keyboardHeight", "toolBarHeight", "safeHeight", "formats", "imageUrl", "webpImageUrl", "inputValue"];
  var pageWxsObj = {};
