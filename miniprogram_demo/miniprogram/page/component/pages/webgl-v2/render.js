...
function run(_ref) {
  var page = _ref.page,
      compareVersion = _ref.compareVersion;
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'webgl'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
      ...
      "children": [{
        ...
        "wxIf": function wxIf(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1Adata.canIUse\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
        ...
        "attributes": [{
          "key": "style",
          "value": "margin: 15px; text-align:center"
        }],
        "children": [{
          "content": "微信版本过低，暂不支持本功能",
          "uid": "2435"
        }],
        "uid": "2434",
        "wxElse": true
