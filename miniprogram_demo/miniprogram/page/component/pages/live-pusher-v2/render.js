...
function run(_ref) {
  ...
  var uidEventHandlerFuncMap = {
    "pusher_statechange": {
      "value": "handleLivePusherStateChange",
      "isCatch": false
    },
    "pusher_error": {
      "value": "handleLivePusherError",
      "isCatch": false
    },
    "1226_input": {
      "value": "handleVideoSrcInput",
      "isCatch": false
    },
    "1228_tap": {
      "value": "handleScanQRCode",
      "isCatch": false
    },
    "1234_tap": {
      "value": "handleStart",
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'live-pusher'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
