...
function run(_ref) {
  ...
  var uidEventHandlerFuncMap = {
    "myVideo_error": {
      "value": "videoErrorCallback",
      "isCatch": false
    },
    "myVideo_enterpictureinpicture": {
      "value": "bindVideoEnterPictureInPicture",
      "isCatch": false
    },
    "myVideo_leavepictureinpicture": {
      "value": "bindVideoLeavePictureInPicture",
      "isCatch": false
    },
    "2317_change": {
      "value": "handleSwitchChange",
      "isCatch": false
    },
    "2333_blur": {
      "value": "bindInputBlur",
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'video'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
          ...
          "attributes": [{
            ...
            "value": function value(data) {
              ...
              try {
                ...
                console.warn("\u6267\u884C\uFF1Adata.danmuList\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
            ...
            "key": "showCastingButton",
            "value": true
          }, {
            "key": "showScreenLockButton",
            "value": true
          }, {
            "key": "showCenterPlayBtn",
            "value": function value(data) {
              var res = "";
            ...
            "value": function value(data) {
              ...
              try {
                ...
                console.warn("\u6267\u884C\uFF1A[\n    'push',\n    'pop'\n]\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
            ...
            "value": function value(data) {
              ...
              try {
                res = data.enableAutoRotation;
              } catch (e) {
                console.warn("\u6267\u884C\uFF1Adata.enableAutoRotation\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
