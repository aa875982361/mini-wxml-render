...
function run(_ref) {
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'label'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
      ...
      "children": [{
        ...
        "children": [{
          ...
          "children": [{
              ...
              "children": [{
                ...
                "attributes": [{
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      ...
                      console.warn("\u6267\u884C\uFF1Adata._item.name\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      res = data._item.checked;
                    } catch (e) {
                      console.warn("\u6267\u884C\uFF1Adata._item.checked\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
                ...
                "children": [{
                  "content": function content(data) {
                    ...
                    try {
                      res = data._item.value;
                    } catch (e) {
                      console.warn("\u6267\u884C\uFF1Adata._item.value\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
            ...
            "wxFor": function wxFor(data) {
              ...
              try {
                res = data.checkboxItems;
              } catch (e) {
                console.warn("\u6267\u884C\uFF1Adata.checkboxItems\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
            ...
            "wxForVarNameList": [{
              "key": "item",
              "secondKeyList": ["name", "checked", "value"]
            }, {
              "key": "index"
            }]
          }],
          ...
          "children": [{
            ...
            "wxFor": function wxFor(data) {
              ...
              try {
                ...
                console.warn("\u6267\u884C\uFF1Adata.radioItems\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
        ...
        "children": [{
          ...
          "children": [{
            ...
            "children": [{
              "content": "点击该label下的文字默认选中第一个checkbox",
              "uid": "1149"
            }],
            "uid": "1148"
          }],
  ...
  var dataKeys = ["list", "item", "theme", "platform", "position", "showCanvas", "frameHeight", "frameWidth", "width", "height", "src", "videoSrc", "result", "canIUse", "items", "latitude", "longitude", "editorHeight", "placeholder", "isIOS", "keyboardHeight", "toolBarHeight", "safeHeight", "formats", "imageUrl", "webpImageUrl", "inputValue", "checkboxItems", "radioItems"];
  var pageWxsObj = {};
