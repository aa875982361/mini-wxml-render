    ...
    "children": [{
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'icon'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
      ...
      "children": [{
        ...
        "children": [{
          ...
          "children": [{
            "content": "用于表示信息提示；也常用于缺乏条件的操作拦截，提示用户所需信息",
            "uid": "701"
          }],
          "uid": "700"
        }],
      ...
      "children": [{
        ...
        "children": [{
          ...
          "children": [{
            "content": "用于表示操作后将引起一定后果的情况；也用于表示由于系统原因而造成的负向结果",
            "uid": "715"
          }],
          "uid": "714"
        }],
      ...
      "children": [{
        ...
        "children": [{
          ...
          "children": [{
            "content": "用于表示由于用户原因造成的负向结果；也用于表示操作后将引起不可挽回的严重后果的情况",
            "uid": "729"
          }],
          "uid": "728"
        }],
      ...
      "children": [{
        ...
        "children": [{
          ...
          "children": [{
            "content": "用于多选控件中，表示该项目可被选择，但还未选择",
            "uid": "777"
          }],
          "uid": "776"
        }],
