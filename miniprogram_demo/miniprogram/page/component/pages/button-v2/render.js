...
function run(_ref) {
  ...
  var uidEventHandlerFuncMap = {
    ...
    "247_getphonenumber": {
      "value": "handleGetPhoneNumber",
      "isCatch": false
    },
    "250_getuserinfo": {
      "value": "handleGetUserInfo",
      "isCatch": false
    },
    "253_opensetting": {
      "value": "handleOpenSetting",
      "isCatch": false
    }
  };
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'button'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
  ...
  var dataKeys = ["list", "item", "theme", "platform"];
  var pageWxsObj = {};
