...
function run(_ref) {
  ...
  var uidEventHandlerFuncMap = {
    "1659_change": {
      "value": "bindPickerChange",
      "isCatch": false
    },
    "1683_change": {
      "value": "bindTimeChange",
      "isCatch": false
    },
    "1707_change": {
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'picker'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
                ...
                "attributes": [{
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      ...
                      console.warn("\u6267\u884C\uFF1Adata.index\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      ...
                      console.warn("\u6267\u884C\uFF1Adata.array\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
                ...
                "children": [{
                  ...
                  "children": [{
                    "content": function content(data) {
                      ...
                      try {
                        res = data.array[data.index];
                      } catch (e) {
                        console.warn("\u6267\u884C\uFF1Adata.array[data.index]\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                      }
                ...
                "attributes": [{
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      ...
                      console.warn("\u6267\u884C\uFF1Adata.time\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
                ...
                "attributes": [{
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      ...
                      console.warn("\u6267\u884C\uFF1Adata.date\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
