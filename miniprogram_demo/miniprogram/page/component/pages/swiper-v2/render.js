...
function run(_ref) {
  ...
  var uidEventHandlerFuncMap = {
    "2127_change": {
      "value": "changeIndicatorDots",
      "isCatch": false
    },
    "2138_change": {
      "value": "changeAutoplay",
      "isCatch": false
    },
    "2155_change": {
  ...
  var templateVDomCreateList = [{
    ...
    "children": [{
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'swiper'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
      ...
      "children": [{
        ...
        "attributes": [{
          "key": "class",
          "value": "page-section page-section-spacing swiper"
        }],
        "children": [{
          "tagName": "swiper",
          "attributes": [{
            ...
            "value": function value(data) {
              ...
              try {
                res = data.indicatorDots;
              } catch (e) {
                console.warn("\u6267\u884C\uFF1Adata.indicatorDots\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
            ...
            "value": function value(data) {
              ...
              try {
                ...
                console.warn("\u6267\u884C\uFF1Adata.autoplay\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
            ...
            "value": function value(data) {
              ...
              try {
                ...
                console.warn("\u6267\u884C\uFF1Adata.interval\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
            ...
            "value": function value(data) {
              ...
              try {
                ...
                console.warn("\u6267\u884C\uFF1Adata.duration\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
          ...
          "children": [{
              ...
              "children": [{
                ...
                "attributes": [{
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      res = "swiper-item " + data.item + "";
                    } catch (e) {
                      console.warn("\u6267\u884C\uFF1A\"swiper-item \"+(data.item)+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
            ...
            "uid": "2106",
            "wxFor": function wxFor(data) {
              var res = "";

              try {
                res = data.background;
              } catch (e) {
                console.warn("\u6267\u884C\uFF1Adata.background\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
        ...
        "attributes": [{
          ...
          "key": "style",
          "value": "margin-top: 20px;margin-bottom: 0;"
        }],
        "children": [{
          "tagName": "pure-view",
          "attributes": [{
          ...
          "children": [{
            ...
            "attributes": [{
              "key": "class",
              "value": "weui-cell weui-cell_switch"
            }],
            "children": [{
              "tagName": "pure-view",
              "attributes": [{
        ...
        "attributes": [{
          "key": "class",
          "value": "page-section page-section-spacing"
        }],
        "children": [{
          "tagName": "pure-view",
          "attributes": [{
