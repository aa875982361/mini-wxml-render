...
function run(_ref) {
      ...
      "attributes": [{
        ...
        "value": function value(data) {
          ...
          try {
            ...
            console.warn("\u6267\u884C\uFF1A{title:'image'}\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
          }
            ...
            "attributes": [{
              ...
              "value": function value(data) {
                ...
                try {
                  ...
                  console.warn("\u6267\u884C\uFF1Adata.imageUrl\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                }
          ...
          "children": [{
            ...
            "attributes": [{
              ...
              "value": function value(data) {
                ...
                try {
                  res = data.webpImageUrl;
                } catch (e) {
                  console.warn("\u6267\u884C\uFF1Adata.webpImageUrl\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                }
  ...
  var dataKeys = ["list", "item", "theme", "platform", "position", "showCanvas", "frameHeight", "frameWidth", "width", "height", "src", "videoSrc", "result", "canIUse", "items", "latitude", "longitude", "editorHeight", "placeholder", "isIOS", "keyboardHeight", "toolBarHeight", "safeHeight", "formats", "imageUrl", "webpImageUrl"];
  var pageWxsObj = {};
