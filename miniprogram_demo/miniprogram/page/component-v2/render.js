...
function run(_ref) {
  ...
  var templateVDomCreateList = [{
    ...
    "children": [{
      ...
      "children": [{
        ...
        "children": [{
          "content": "以下将展示小程序官方组件能力，组件样式仅供参考，开发者可根据自身需求自定义组件样式，具体属性参数详见",
          "uid": "7"
        }, {
          "tagName": "navigator",
          "attributes": [{
            "key": "url",
            "value": "pages/doc-web-view/doc-web-view"
          }, {
            "key": "class",
            "value": "weui-agree__link"
          }],
          "children": [{
            "content": "小程序开发文档",
            "uid": "9"
          ...
          "attributes": [{
            ...
            "value": function value(data) {
              ...
              try {
                ...
                console.warn("\u6267\u884C\uFF1Adata.list\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
              }
            ...
            "children": [{
              ...
              "attributes": [{
                ...
                "value": function value(data) {
                  ...
                  try {
                    res = "kind-list-item-hd " + (data.item.open ? 'kind-list-item-hd-show' : '') + "";
                  } catch (e) {
                    console.warn("\u6267\u884C\uFF1A\"kind-list-item-hd \"+(data.item.open ? 'kind-list-item-hd-show' : '')+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                  }
              ...
              "children": [{
                ...
                "children": [{
                  "content": function content(data) {
                    ...
                    try {
                      ...
                      console.warn("\u6267\u884C\uFF1Adata.item.name\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
                ...
                "attributes": [{
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      res = "resources/kind/" + data.item.id + "_dark.png";
                    } catch (e) {
                      console.warn("\u6267\u884C\uFF1A\"resources/kind/\"+(data.item.id)+\"_dark.png\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
                ...
                "children": [],
                "uid": "26",
                "wxIf": function wxIf(data) {
                  var res = "";

                  try {
                    res = data.theme === 'dark';
                  } catch (e) {
                    console.warn("\u6267\u884C\uFF1Adata.theme === 'dark'\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                  }
                ...
                "attributes": [{
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      res = "resources/kind/" + data.item.id + ".png";
                    } catch (e) {
                      console.warn("\u6267\u884C\uFF1A\"resources/kind/\"+(data.item.id)+\".png\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
              ...
              "uid": function uid(data) {
                ...
                try {
                  ...
                  console.warn("\u6267\u884C\uFF1Adata.item.id\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                }
              ...
              "attributes": [{
                ...
                "value": function value(data) {
                  ...
                  try {
                    res = "kind-list-item-bd " + (data.item.open ? 'kind-list-item-bd-show' : '') + "";
                  } catch (e) {
                    console.warn("\u6267\u884C\uFF1A\"kind-list-item-bd \"+(data.item.open ? 'kind-list-item-bd-show' : '')+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                  }
              ...
              "children": [{
                ...
                "attributes": [{
                  ...
                  "value": function value(data) {
                    ...
                    try {
                      res = "navigator-box " + (data.item.open ? 'navigator-box-show' : '') + "";
                    } catch (e) {
                      console.warn("\u6267\u884C\uFF1A\"navigator-box \"+(data.item.open ? 'navigator-box-show' : '')+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                    }
                  ...
                  "attributes": [{
                    ...
                    "value": function value(data) {
                      ...
                      try {
                        ...
                        console.warn("\u6267\u884C\uFF1Adata.item.pages\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                      }
                  ...
                  "children": [{
                    ...
                    "attributes": [{
                      ...
                      "value": function value(data) {
                        ...
                        try {
                          res = "pages/" + data.page + "/" + data.page + "";
                        } catch (e) {
                          console.warn("\u6267\u884C\uFF1A\"pages/\"+(data.page)+\"/\"+(data.page)+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                        }
                      ...
                      "children": [{
                        "content": function content(data) {
                          ...
                          try {
                            ...
                            console.warn("\u6267\u884C\uFF1A\"\u539F\u751F\"+(data.page)+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                          }
                    ...
                    "attributes": [{
                      ...
                      "value": function value(data) {
                        ...
                        try {
                          res = "pages/" + data.page + "-v2/" + data.page + "";
                        } catch (e) {
                          console.warn("\u6267\u884C\uFF1A\"pages/\"+(data.page)+\"-v2/\"+(data.page)+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                        }
                      ...
                      "children": [{
                        "content": function content(data) {
                          ...
                          try {
                            ...
                            console.warn("\u6267\u884C\uFF1A\"\u52A8\u6001\"+(data.page)+\"\"\uFF0C\u5931\u8D25", e === null || e === void 0 ? void 0 : e.message);
                          }
  ...
  Page({
    ...
    onLoad: function onLoad() {
      ...
      if (wx.onThemeChange) {
        wx.onThemeChange(function (_ref6) {
