...
const wxsMap = {};
const pageWxs = {}
const uidEventHandlerFuncMap = {"11_tap":"myclick"};
const templateVDomCreateList = [
  {
    ...
    "_a": [
      ...
      var res = "";
      try{
        res = "sax"+(data.myClass)+" xxxs"
      }catch(e){
        console.warn(`执行："sax"+(data.myClass)+" xxxs"，失败`, e?.message)
        // console.warn("错误：", e)
      }
      return res
    }
      ...
      try{
        ...
        console.warn(`执行：false，失败`, e?.message)
        // console.warn("错误：", e)
      }
      return res
    }
...
const dataKeys = ["myClass","showData"]
const pageWxsObj = {}
